...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        quanLyKho.themPhuTung(new PhuTung("pt001", "Lọc Gió Máy Lạnh ", "Denso", "AUDI Q7", "Copy"));
        quanLyKho.themPhuTung(new PhuTung("pt002", "Lọc Nhớt Động Cơ ", "Toyota", "Camry 2.5", "Auth"));
        int choice = -1;
        while (choice != 0) {
            System.out.println("+---------------------------------------------------------------------+");
